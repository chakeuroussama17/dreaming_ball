        ...
        child: ListView(
          ...
          children: [
            ...
            _navCard(context, primary, secondary, border, surface,
                ...
                title: 'Agent Chats',
                subtitle: 'Plan requests & messages from agents',
                route: 'admin-chats'),
            _navCard(context, primary, secondary, border, surface,
                icon: Icons.emoji_events_outlined,
                title: 'Tournament Approvals',
                subtitle: 'Review tournament applications',
            ...
            _navCard(context, primary, secondary, border, surface,
                ...
                subtitle: 'Games, money collected & commission by agent',
                route: 'admin-agent-stats'),
            _navCard(context, primary, secondary, border, surface,
